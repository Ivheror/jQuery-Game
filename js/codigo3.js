...
function detectarColision(){
  ...
  if (bColisionPjEnemigo > 0 || bColisionPjEnemigo2>0 || bColisionPjEnemigo3>0)  
  {
  ...
  $(".manzana").each(function()
  {
    if($('#enemigo')!= null)
    {
      if (collision($(this),$('#enemigo')) > 0 || collision($(this),$('#enemigo2')) > 0 || collision($(this),$('#enemigo3')) > 0) 
      {
        ...
        if (esVisible1==false && esVisible2== false && esVisible3== false) 
        {
