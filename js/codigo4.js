...
function detectarColision(){
  ...
  if (bColisionPjEnemigo > 0 || bColisionPjEnemigo2>0 
    || bColisionPjEnemigo3>0 || bColisionPjEnemigo4>0)  
  {
  ...
  $(".manzana").each(function()
  {
    if($('#enemigo')!= null)
    {
      if (collision($(this),$('#enemigo')) > 0 || collision($(this),$('#enemigo2')) > 0 ||
       collision($(this),$('#enemigo3')) > 0 || collision($(this),$('#enemigo4')) > 0) 
      {
        ...
        if (esVisible1==false && esVisible2== false && esVisible3== false  && esVisible4== false) 
        {
          var img=$('<img/>',{id:'llave',src:'img/key.gif',width:'100px',height:'150px'}).appendTo('#contenedor');
            ...
            if ($("#llave").dblclick(function(){
            {
              ...
              $( "#dialog-message" ).dialog({
                ...
                buttons: {
                  Avanzar: function() {
                    window.location.assign("Fase5.html");
                    $( this ).dialog( "close" );
                  },
                  Repetir:function(){
